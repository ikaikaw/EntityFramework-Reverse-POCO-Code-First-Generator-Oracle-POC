...
--
--
GRANT REFERENCES, SELECT, INSERT, UPDATE, DELETE ON employees TO efpoco;
GRANT REFERENCES, SELECT ON regions TO efpoco;
GRANT REFERENCES, SELECT ON countries TO efpoco;
GRANT REFERENCES, SELECT ON locations TO efpoco;
GRANT SELECT ON jobs TO efpoco;
GRANT SELECT ON job_history TO efpoco;
GRANT SELECT ON departments TO efpoco;